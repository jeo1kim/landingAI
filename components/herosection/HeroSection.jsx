        ...
        <rect width="100%" height="100%" strokeWidth={0} fill="url(#983e3e4c-de6d-4c3f-8d64-b9761d1534cc)" />
          ...
          /> */}
              ...
              <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                Earn rewards from <br /> Chatting with AI    </h1>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Earn points everytime you interact with our Chatbot AI and redeem for cash prizes and more!          </p>

              <div className="mt-10 flex items-center gap-x-6">
                <a href="#" className="text-sm font-semibold leading-6 text-white">
                  <img src="https://static.wixstatic.com/media/84770f_75b1345329464348876e3c99f0c1833f~mv2.png/v1/fill/w_140,h_41,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Google_Play_Store_badge_EN.png">
                  </img>
                </a>

                <a href="#" className="text-sm font-semibold leading-6 text-white">
                <img src="https://static.wixstatic.com/media/84770f_eb358dba3c764099b17fd5241d42c715~mv2.png/v1/fill/w_137,h_41,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Download_on_the_App_Store_Badge.png">
                  </img>
                </a>
              </div>
            </div>
